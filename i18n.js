(() => {
  ...
  const zh = {
    ...
    ,'Gross mode uses actual strokes. Net mode applies the same full-handicap strokes as Las Vegas. The landlord’s score is multiplied by the number of peasants and compared with their combined score.': '总杆按实际杆数计算；净杆采用与拉斯一致的完整差点分洞让杆。地主杆数乘以农民人数后，与所有农民的组合杆数比较。'
    ,'The hole is settled after every player enters a score, and each player’s win or loss is shown immediately.': '所有球员录入杆数后结算本洞，并立即显示每位球员的输赢。'
